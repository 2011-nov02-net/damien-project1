...
namespace ArkhenManufacturing.Library.Test.Repository.Ephemeral
{
    public class InternalRepository_UtilityTests
    {
        ...
        #region Location Utility Tests

        #endregion

        #region Customer Utility Tests

        #endregion

        #region Admin Utility Tests
        ...
        #region Product Utility Tests

        #endregion

        #region InventoryEntry Utility Tests

        #endregion

        #region Address Utility Tests
